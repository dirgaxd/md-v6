                ...
                if (chat.welcome) {
                    ...
                    for (let user of participants) {
                        ...
                        try {
                            ...
                            text = (action === 'add' ? (chat.sWelcome || this.welcome || conn.welcome || 'Welcome, @user!').replace('@subject', await this.getName(id)).replace('@desc', groupMetadata.desc ? groupMetadata.desc : '') :
                                (chat.sBye || this.bye || conn.bye || 'Bye, @user!')).replace('@user', await this.getName(user))
                            await this.sendMessageModify(id, text, null, { ads: true, largeThumb: true, title: 'Simple WhatsApp Bot', thumbnail: await getBuffer(action === 'add' ? 'https://telegra.ph/file/f88bc559017895c1dd31f.jpg' : 'https://telegra.ph/file/01001b9e5a863eefd8368.jpg') })
                        }
                    }
                }
                break
