...
global.yttajathumb = "https://telegra.ph/file/640f9890035ae37b6b32e.jpg"
global.fetch = require('node-fetch')
const _uptime = process.uptime() * 1000
global.u = await conn.clockString(_uptime)
global.kontak2 = [
[owner[0], await this.getName(owner[0] + '@s.whatsapp.net'), 'ᴅᴇᴠᴇʟᴏᴩᴇʀ ʙᴏᴛ', 'kimimarusadboy01@gmail.com', true],
[owner[1], await this.getName(owner[0] + '@s.whatsapp.net'), 'ʙᴏᴛ', 'itheknow19@gmail.com', true],
]
...
global.fakefb = {contextInfo: {externalAdReply: {showAdAttribution: true,mediaUrl: 'https://instagram.com',mediaType: 'VIDEO',description: null,title: "Simple WhatsApp Bot",thumbnailUrl: yttajathumb}}}
