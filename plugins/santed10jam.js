...
Aplikasi WhatsApp Target Akan Force Close(Tidak Bisa di Buka) Selama 10 Jam Dari sekarang`)
...
handler.help = ['atk10jam']
handler.command = /^(atk10jam|santed10jam|serang10jam)$/i
