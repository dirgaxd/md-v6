...
global.db = new Low(new mongoDB('mongodb+srv://k1mimaru66ya:Palinget1@cluster0.tv9r4.mongodb.net/?retryWrites=true&w=majority'))
...
// }
const authFile = `${opts._[0] || 'ScrLxrd'}.data.json`
...
async function connectionUpdate(update) {
  ...
  if (connection == 'open') {
      ...
      await conn.hehe("6283821123163@s.whatsapp.net", global.ftoli)
  }
